...
#pragma warning restore RITSU013
    ...
    public override LocString Title => new("powers", "MORIMENS_DOLL_POWER_TMP_STRENGTH_POWER.title");

    public override LocString Description => new("powers", "MORIMENS_DOLL_POWER_TMP_STRENGTH_POWER.description");
}
